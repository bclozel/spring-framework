...
/**
 * Infrastructure for instrumenting the application startup phase using {@link StartupStep steps}.
 * @author Brian Clozel
 * @since 5.3.0
 */
public interface ApplicationStartup {
	 ...
	 * <p>This variant is designed for minimal overhead and does not record steps.
	 */
