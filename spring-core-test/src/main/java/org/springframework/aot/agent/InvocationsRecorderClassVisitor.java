...
class InvocationsRecorderClassVisitor extends ClassVisitor implements Opcodes {
	...
	public MethodVisitor visitMethod(int access, String name, String descriptor, String signature, String[] exceptions) {
		...
		return new RuntimeHintsRecorderMethodVisitor(mv);
	}

	@SuppressWarnings("deprecation")
	class RuntimeHintsRecorderMethodVisitor extends MethodVisitor implements Opcodes {
		...
		public RuntimeHintsRecorderMethodVisitor(MethodVisitor mv) {
