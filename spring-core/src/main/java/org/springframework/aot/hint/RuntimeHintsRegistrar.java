 ...
 * and can only use the current {@link ClassLoader} to conditionally contribute hints.
...
public interface RuntimeHintsRegistrar {
	 ...
	 * @param beanClassLoader the bean classloader
	 */
	void registerHints(RuntimeHints hints, @Nullable ClassLoader beanClassLoader);
