...
public class StaticSpringFactoriesGenerator {
	...
	public MethodReference generateStaticSpringFactories(GenerationContext generationContext) {
		...
		generationContext.getRuntimeHints().reflection()
				.registerType(TypeReference.of(staticSpringFactoriesClass.getName().canonicalName()),
						typeHint -> typeHint.withMethod("initialize",
								Collections.singletonList(TypeReference.of(ClassLoader.class)),
